					...
					<section id="content">
						<section class="vbox">
							<section class="scrollable padder">
								...
								<!-- 表格标题 -->
								<div class="m-b-md">
									<h3 class="m-b-none">公文审核</h3>
								</div>
								
								<!-- 增删改结果提示 -->
								<jsp:include page="/common/top.jsp"></jsp:include>
								
								<form action="<%= basePath %>article/toAduit" method="post" data-validate="parsley">
									<!-- 需要审核的公文列表 -->
									<div class="tab-pane" id="audit">
										<section class="panel panel-default">
											<header class="panel-heading">需要审核的公文</header>
															...
															<c:when test="${!empty articles}">
																<c:forEach items="${articles}" var="article">
																	...
																	<tr>
																		...
																		<td style="line-height: 30px;text-align: center;">
																			<a href="<%= basePath %>article/toAuditPage?articleId=${article.articleid}" class="btn btn-info btn-sm">审核</a>
																		</td>
																	</tr>
																</c:forEach>
															</c:when>
