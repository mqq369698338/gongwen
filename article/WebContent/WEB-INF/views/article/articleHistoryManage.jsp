						...
						<section class="vbox">
							<section class="scrollable padder">
								...
								<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
									...
									<li class="active">公文历史信息</li>
								</ul>
								
								<!-- 表格标题 -->
								<div class="m-b-md">
									<h3 class="m-b-none">公文历史信息</h3>
								</div>
								...
								<div class="tab-pane" id="published">
									<section class="panel panel-default">
										<header class="panel-heading">公文历史信息</header>
										
										<form action="<%= basePath %>article/getMyHistoryList" method="post" data-validate="parsley">
											<!-- 查询条件 -->
												...
												<div class="col-sm-10 m-b-xs">
													<div class="inline" style="margin-right:20px;">
														...
														<input type="text" id="keyword" name="keyword" class="input-sm form-control inline" 
															style="width: 150px;" placeholder="请输入公文标题"
															...
															<c:when test="${!empty articles}">
																<c:forEach items="${articles}" var="article">
																	<tr>
																		...
																		<td style="line-height: 30px;text-align: center;">
																			<a href="<%= basePath %>article/findByIdHistory?articleId=${article.articleid}" class="btn btn-success btn-sm">查看/预览</a>
																		</td>
																	</tr>
																</c:forEach>
															</c:when>
...
<!-- 													</thead> -->
		...
		<script type="text/javascript">
			...
			function getRequestURL(page) {
				...
				var url = host + "article/getMyHistoryList?pageNo=" + pageNo + "&pageCount=" + pageCount 
							+ "&keyword=" + keyword;
				return url;
			}
